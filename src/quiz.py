...
class Quiz:
    ...
    def __init__(self):
        ...
        self.question_list = []
        self.url = ''
        self.categories = {9: 'General Knowledge', 10: 'Books', 11: 'Film', 12: 'Music', 13: 'Musicals & Theatres',
                           14: 'Television', 15: 'Video Games',
                           16: 'Board Games', 17: 'Science & Nature', 18: 'Computers', 19: 'Mathematics',
                           20: 'Mythology', 21: 'Sports', 22: 'Geography',
                           23: 'History', 24: 'Politics', 25: 'Art', 26: 'Celebrities', 27: 'Animals', 28: 'Vehicles',
                           29: 'Comics', 30: 'Gadgets',
    ...
    def create_question_list(self):
        ...
        self.build_url(self.num_questions,
                       self.subject, self.difficulty, self.question_type)
        raw_text = parse_site(self.url)
        self.parse_open_trivia(raw_text)
    ...
    def build_url(self, num_questions, subject, difficulty, question_type):
        ...
        self.url += f"amount={num_questions}&"
        self.url += f"category={subject}&"
        self.url += f"difficulty={difficulty}&"
        self.url += f"type={question_type}"
